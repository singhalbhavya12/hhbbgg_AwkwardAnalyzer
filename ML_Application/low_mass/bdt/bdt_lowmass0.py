...
# Choose engineered feature set: none / boosted / pt_jj_only / pt_gg_only
...
ENGINEERED_FEATURE_SET_NAME = "boosted"
...
BASE_OUTPUT_DIR = (
    ...
    "hhbbgg_AwkwardAnalyzer/ML_Application/low_mass/bdt_output/disc_low2022/"
)
...
def train_and_save(sig, bkg, outdir, run_label, signal_points_meta, mass_category_tag):
    ...
    data = clean_sentinel_values(data, DIRECT_FEATURES + REQUIRED_ENGINEERING_COLS)
