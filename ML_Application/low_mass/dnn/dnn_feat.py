...
MASS_CATEGORIES = {
    "280": [280],  # special handling: one (MX, MY) point at a time
    "low": LOW_X_MASSES,
    "mid": MID_X_MASSES,
    "high": HIGH_X_MASSES,
...
DNN_PARAMS = dict(
    hidden_layers       = [128, 64, 32],  # one extra hidden layer
...
def main():
    ...
    for feat_name, feat_list in FEATURE_SETS.items():
        ...
        OUTPUT_DIR = (
            ...
            f"hhbbgg_AwkwardAnalyzer/ML_Application/low_mass/dnn_output/3layers_{SIG_LABEL}/"
        )
